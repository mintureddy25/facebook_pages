      ...
      <div className="absolute inset-0 flex items-center justify-center py-24 sm:py-32 lg:px-8 lg:py-40">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-3xl w-full p-8">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Connect with Facebook to Gain Insights
          </p>
          <p className="mt-6 text-base leading-7 text-gray-700">
            Log in with Facebook to access detailed analytics for your page.
            Monitor engagement, track growth, and understand your audience
            better. All the metrics you need to make informed decisions are just
            a login away.
          </p>
          <div className="mt-8">
            <FacebookLoginButton />
